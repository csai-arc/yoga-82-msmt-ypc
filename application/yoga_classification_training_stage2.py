...
def objective(trial) :
    ...
    train_dataset = list_dataset.txtfile_classification(base_path, train_data,
    ...
    val_loader   = torch.utils.data.DataLoader(val_dataset, batch_size= args.test_batch, shuffle=False,
                                               num_workers=4, drop_last=True, pin_memory=True) # test_batch
    ...
    lr = trial.suggest_float("lr", 4e-3, 8e-3, log=True)
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        train_loss, train_acc, train_yoga6_top1_avg, train_yoga20_top1_avg, train_yoga82_top1_avg = train(train_loader, model, criterion, optimizer, epoch, use_cuda)
